...
path_to_pais <- "analysis/abricate/AVC171_all/pEC14_114.txt"
refname <- "pEC14_114"
...
tree$tip.label <- gsub("Reference", "AVC171", tree$tip.label)
...
write.csv(x = listy_, file = paste0("delims/",refname, "_plasmid_coverage.csv"), row.names = TRUE)

write.csv(x = df6, file = paste0("delims/",refname, "_plasmid_coverage_percentage.csv"), row.names = TRUE)
